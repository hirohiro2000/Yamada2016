...
//		var a = GameObjectExtension.GetComponentInParentAndChildren<ResourceParameter>( obj.gameObject );
//		var d = GetComponent<ResourceParameter>();

//		ResourceParameter.ComputeDamage( a, ref d, true );
